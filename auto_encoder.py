...
def standard_scale(X_train, X_test):
	...
	X_train_std = preprocesser.transform(X_train)
	X_test_std = preprocesser.transform(X_test)
...
batch_size = 128
display_step = 1
autoencoder = AdditiveGaussianNoiseAutoencoder(n_input=784,n_hidden=200,optimizer=tf.train.AdamOptimizer(learning_rate=0.001), scale=0.01)
